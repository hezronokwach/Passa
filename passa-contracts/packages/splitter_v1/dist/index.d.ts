...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDSQI2GWKWN6Z2K37EL35ONYGGEJK74PVX3MZJOX7EOLQBY5W5LR4Y4A";
    };
};
...
export interface Client {
     ...
     */
    create_agreement: ({ id, payer, token, payees, budget, deadline, approvers }: {
        id: string;
        payer: string;
        token: string;
        payees: Array<Share>;
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        create_agreement: (json: string) => AssembledTransaction<null>;
        release: (json: string) => AssembledTransaction<null>;
        release_split: (json: string) => AssembledTransaction<null>;
        close: (json: string) => AssembledTransaction<null>;
        get: (json: string) => AssembledTransaction<Option<Agreement>>;
    };
}
