...
export const networks = {
  testnet: {
    ...
    contractId: "CANZNZKFGNNN4KMKN7HAILG2S6ZOT4UXEVFWNIGDPO46PCKUAINJEGKP",
  }
} as const
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        "AAAAAQAAAAAAAAAAAAAABVNoYXJlAAAAAAAAAgAAAAAAAAAMZml4ZWRfYW1vdW50AAAACwAAAAAAAAAJcmVjaXBpZW50AAAAAAAAEw==",
