                ...
                <section className="relative w-full min-h-screen overflow-hidden bg-black">
                    ...
                    <div className="absolute inset-0">
                        <svg className="w-full h-full opacity-10" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid slice">
                            ...
                            <rect width="100%" height="100%" fill="url(#circles)" className="text-white"/>
                        </svg>
                    </div>
                    
                    <div className="absolute inset-0">
                        <svg className="w-full h-full opacity-5" viewBox="0 0 200 200" preserveAspectRatio="xMidYMid slice">
                            <defs>
                            ...
                            <rect width="100%" height="100%" fill="url(#diamonds)" className="text-white"/>
                        </svg>
                    </div>
                    ...
                    <div className="relative z-10 pt-32 pb-16">
                        <div className="container mx-auto px-6 flex justify-center">
                            <div className="inline-flex items-center px-6 py-3 bg-white/10 backdrop-blur-md border border-white/20 rounded-full">
                                <span className="font-medium" style={{color: '#E99125'}}>Seamless payment</span>
                                <span className="text-white mx-2">•</span>
                                <span className="font-medium" style={{color: '#296F5E'}}>Faster Processing</span>
                            </div>
                        </div>
                    </div>

                    <div className="container mx-auto px-6 grid lg:grid-cols-12 gap-12 items-center relative z-10 min-h-[calc(100vh-300px)]">
                        {/* Left Side - Text Content */}
                        <div className="lg:col-span-6 text-center lg:text-left">
                            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
                                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8">
                                    <div style={{color: '#E99125'}} className="mb-2">Experience</div>
                                    <div style={{color: '#E32527'}} className="mb-2">Events.</div>
                                    <div className="text-white mb-2">&</div>
                                    <div style={{color: '#296F5E'}} className="mb-2">Relive</div>
                                    <div style={{color: '#296F5E'}} className="mb-2">Every</div>
                                    <div style={{color: '#296F5E'}}>Moment</div>
                                </h1>
                                <p className="text-white/80 text-xl md:text-2xl font-light max-w-2xl mx-auto lg:mx-0 mb-8 leading-relaxed">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                                    <button 
                                        ...
                                        className="group px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 flex items-center gap-3 hover:scale-105 hover:shadow-2xl text-white"
                                        style={{backgroundColor: '#E99125', boxShadow: '0 0 40px rgba(233, 145, 37, 0.2)'}}
                                    >
                                        Explore Events
                                    ...
                                    <button 
                                        ...
                                        className="bg-transparent border-2 border-white/30 hover:border-white text-white px-8 py-4 rounded-full font-semibold text-lg transition-all duration-300 hover:bg-white/10 hover:scale-105"
                                    >
                                        Become a Creator
                                    </button>
                                </div>
                        ...
                        <div className="lg:col-span-6 relative">
                            ...
                            <motion.div
                                ...
                                className="relative p-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-2xl mb-6"
                            >
                                <div className="space-y-6">
                                    <div className="flex items-center gap-4">
                                        <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{backgroundColor: '#E99125' + '20'}}>
                                            <Zap className="w-7 h-7" style={{color: '#E99125'}} />
                                        </div>
                                        <div>
                                            <h3 className="text-white font-bold text-lg">Instant Payouts</h3>
                                            <p className="text-white/70">Artists paid in real-time</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-4">
                                        <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{backgroundColor: '#296F5E' + '20'}}>
                                            <Verified className="w-7 h-7" style={{color: '#296F5E'}} />
                                        </div>
                                        <div>
                                            <h3 className="text-white font-bold text-lg">Verified Tickets</h3>
                                            <p className="text-white/70">Blockchain secured</p>
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
                            ...
                            {/* Floating Elements */}
                            <div className="absolute -top-6 -right-6 w-28 h-28 bg-white/5 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center">
                                <div className="w-4 h-4 rounded-full animate-pulse" style={{backgroundColor: '#E32527'}}></div>
                            </div>
                            <div className="absolute -bottom-4 -left-4 px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-xl">
                                <span className="text-white font-medium">100% Secure</span>
                            </div>
                            <div className="absolute top-1/2 -right-8 w-6 h-6 rounded-full animate-pulse delay-500" style={{backgroundColor: '#296F5E'}}></div>
                        </div>
                    </div>
                    ...
                    {/* Side Gradients */}
                    <div className="absolute inset-y-0 left-0 w-32 bg-gradient-to-r from-black via-black/50 to-transparent"></div>
                    <div className="absolute inset-y-0 right-0 w-32 bg-gradient-to-l from-black via-black/50 to-transparent"></div>
                </section>
